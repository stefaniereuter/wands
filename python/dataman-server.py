...
datamanServer.SetParameters({"IPAddress":"0.0.0.0" , "Port":"12306", "Timeout":"5", "TransportMode":"reliable" })


# ADIOS Engine
datamanWriter = datamanServer.Open("data1", adios2.Mode.Write)
sendbuffer = datamanServer.DefineVariable("matrix1",data,shape,start,count,adios2.ConstantDims)
if sendbuffer:
