    ...
    def getaxis(self, axis:str):
        ...
        try:
           raw_data.set_data(self._file.get(axis+'/data')[()])
            ...
            warnings.warn(f"Dataset {axis!s}/data could not be loaded. This might be expected behaviour")
        ...
        try:
            ...
            #don't raise an error as this might be expected behaviour as not always all three components are available
            warnings.warn(f"Dataset {axis!s}/errors could not be loaded. This might be expected behaviour")
        ...
        try:
            ...
            #don't raise an error as this might be expected behaviour as not always all three components are available
            warnings.warn(f"Dataset {axis!s}/time could not be loaded. This might be expected behaviour")
